...
public class Question {
    ...
    public void setText(String text) { // Added setter method
        this.text = text;
    }
    ...
    public List<Answer> getAnswers() {
        return new ArrayList<>(answers); // Return a copy to prevent modification issues
    }
    ...
    public void removeAnswer(int answerId) {
        if (!answers.isEmpty()) { // Prevents unnecessary operations on empty list
